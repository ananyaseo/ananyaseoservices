  ...
  <section className="py-20">
    <div className="container">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground">Read feedback from our valued clients who trust us with their digital marketing needs.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {testimonials.map((t) => (
          <div key={t.author} className="bg-background border rounded-xl p-8 shadow-sm relative">
