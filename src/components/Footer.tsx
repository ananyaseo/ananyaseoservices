...
import footerLogo from "@/assets/ananya-logo-footer.jpg";

const socialLinks = [
  { label: "Facebook", href: "https://www.facebook.com/ananya.seo.services/", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
  )},
  { label: "Instagram", href: "https://www.instagram.com/ananyaseoservices/", icon: (
  ...
  { label: "LinkedIn", href: "https://www.linkedin.com/company/ananya-seo-services", icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
  )},
  { label: "Twitter", href: "https://twitter.com/ananya_seo", icon: (
  ...
  { label: "YouTube", href: "http://www.youtube.com/c/AnanyaseoservicesBengaluru", icon: (
  ...
  <footer className="bg-navy text-navy-foreground py-12">
    <div className="container">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Logo + About */}
        <div>
          <img src={footerLogo} alt="Ananya SEO Services" className="h-14 w-auto mb-4 rounded bg-white p-1" />
          ...
          <div className="space-y-2 text-sm">
            <a href="tel:+919845038936" className="flex items-center gap-2 text-navy-foreground/70 hover:text-primary transition-colors">
              <Phone size={14} /> +91-9845038936
            </a>
            <a href="mailto:sanand.rao@gmail.com" className="flex items-center gap-2 text-navy-foreground/70 hover:text-primary transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {[
              ...
              <li key={l.label}>
                <a href={l.href} className="text-navy-foreground/70 hover:text-primary transition-colors">{l.label}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        {/* Follow Us */}
        <div>
          <h3 className="font-bold text-lg font-heading mb-4">Follow Us</h3>
          <div className="flex flex-wrap gap-3">
            {socialLinks.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="w-10 h-10 rounded-full bg-navy-light flex items-center justify-center text-navy-foreground/70 hover:text-primary hover:bg-navy-foreground/10 transition-colors"
              >
                {s.icon}
              </a>
            ))}
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-navy-foreground/70">
            <p>49, 2nd Main, Arakere MICO Layout I Stage, Bangalore, Karnataka 560076</p>
