          ...
          <div className="flex flex-wrap gap-3">
            {socialLinks.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="w-10 h-10 rounded-full bg-[hsl(210,50%,45%)] flex items-center justify-center text-white hover:scale-125 hover:bg-primary transition-all duration-300"
              >
                {s.icon}
              </a>
            ))}
