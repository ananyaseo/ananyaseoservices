...
import heroImg from "@/assets/blog/ngo-special-offer.jpg";

const NgoSpecialOffer = () => (
  <BlogPostLayout
  ...
  >
    ...
    <p>Ananya SEO Services announced today the launch of a special program for not-for-profit organizations, and NGOs. The awareness of benefits of internet marketing, including SEO, social media and PPC, to drive relevant traffic to the website is low in the social sector. This sector has needs which are different from those of business.</p>
    <p>What makes someone make a donation, spread the word about a campaign, or volunteer? What would make your audience want to act for social change? It is an emotional connection, linking with passion for a cause. This can be distributed or promoted through stories in social media, videos, your blog, PPC ads.</p>
    ...
    <p>All at <strong>50% discount</strong> to the standard fees.</p>
...
export default NgoSpecialOffer;
