...
import heroImg from "@/assets/blog/instagram-sales.png";
...
const InstagramSales = () => (
  ...
  >
    ...
    <ul>
      <li>90% of Instagram users follow at least one brand.</li>
      <li>83% of Instagram users find new brands or products on the platform.</li>
      <li>80% of users say Instagram helps them when deciding to buy a product or service.</li>
    </ul>
    ...
    <ul>
      ...
      <li>Shoot at sunrise, sunset, or on a cloudy day.</li>
      <li>Take photos from different vantage points.</li>
      <li>Use unique frames.</li>
    </ul>
    ...
    <ul>
      ...
      <li><strong>Tag a friend</strong> — Users get one entry for every friend they tag.</li>
      <li><strong>User-generated content (UGC)</strong> — Your audience creates their own unique posts and tags your business.</li>
    </ul>
    ...
    <ul>
      ...
      <li>Plan your videos with a specific goal in mind.</li>
      <li>Add behind-the-scenes footage for a human touch.</li>
      <li>Capture your products in action.</li>
    </ul>
    ...
    <ul>
      ...
      <li>Keep your message short — text will be cut off after two rows.</li>
      <li>Engage with users and treat paid ads just like organic posts.</li>
    </ul>
  </BlogPostLayout>
);
